// Author: Will Gilmour 2024 & I Barnard 2024/25
// Bayesian Learner with Perseveration only model simulation
// BayesSMP_model_simulation.stan
data {
...
generated quantities {
  ...
  for (s in 1:nSubjects) {
      ...
      for (t in 1:nTrials) {        
        ...
        choice[s,t] = categorical_logit_rng( beta[s] * (Q + pb )); // generate action probabilities and selection an action based on this
